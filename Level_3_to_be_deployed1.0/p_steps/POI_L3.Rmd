...
res_1<-fread(paste0(ev_preg_dir,"Masked/", "diagnoses_df_pregnancy_counts_masked.csv"))
...
res_1<-fread(paste0(ev_preg_dir,subpopulations_names[a], "/Masked/", subpopulations_names[a],"_diagnoses_df_pregnancy_counts_masked.csv"))
datatable(res_1, options = list(scrollX=T))
  } else {
  print("This table cannot be produced based on the available data")
}
