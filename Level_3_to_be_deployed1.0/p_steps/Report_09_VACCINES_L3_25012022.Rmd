...
tab15<-fread(paste0(vacc_dir,"Masked/", "vaccines_completeness_masked.csv"))
if (tab15[,.N]>0){
datatable(tab15, options = list(scrollX=T))
} else {
  tab15<-NULL
  ...
  tab15<-fread(paste0(vacc_dir,subpopulations_names[a], "/Masked/", subpopulations_names[a],"_vaccines_completeness_masked.csv"))
  if (tab15[,.N]>0){
datatable(tab15, options = list(scrollX=T))
  } else {
    tab15<-NULL
