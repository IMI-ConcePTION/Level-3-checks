...
tab10_vx<-fread(paste0(vacc_dir,"Masked/", "vaccines_my_atc_1_masked.csv"))
if(tab10_vx[,.N]>0){
...
datatable(head(tab10_vx,12000), options = list(scrollX=T))
  ...
  tab10_vx<-fread(paste0(vacc_dir,subpopulations_names[a], "/Masked/", subpopulations_names[a],"_vaccines_my_atc_1_masked.csv"))
  if (tab10_vx[,.N]>0){
  setcolorder(tab10_vx,c("atc_code_1", "count","total", "meaning", "year", "data_access_provider", "data_source"))
      if(tab10_vx[,.N]>12000){  
    print("If the table contanins more than 12000 records it can not be displayed in the report. For the complete table, go to g_output/VACCINES/vaccines_my_atc_1_masked.csv")
...
tab12_vx<-fread(paste0(vacc_dir,"Masked/", "vaccines_my_atc_4_masked.csv"))
if(tab12_vx[,.N]>0){
  if(tab12_vx[,.N]>12000){
...
datatable(tab12_vx, options = list(scrollX=T))
  ...
  tab12_vx<-fread(paste0(vacc_dir,subpopulations_names[a], "/Masked/", subpopulations_names[a],"_vaccines_my_atc_4_masked.csv"))
  if(tab12_vx[,.N]>0){
if(tab12_vx[,.N]>12000){
      print("If the table contanins more than 12000 records it can not be displayed in the report. For the complete table, go to g_output/VACCINES/vaccines_my_atc_4_masked.csv")
    datatable(head(tab12_vx,12000), options = list(scrollX=T))
...
tab13_vx<-fread(paste0(vacc_dir,"Masked/", "vaccines_my_atc_7_masked.csv"))
...
if(tab13_vx[,.N]>0){
  ...
  tab13_vx<-fread(paste0(vacc_dir,subpopulations_names[a], "/Masked/", subpopulations_names[a],"_vaccines_my_atc_7_masked.csv"))
  if(tab13_vx[,.N]>0){
